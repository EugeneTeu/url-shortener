...
export declare const urlServiceController: {
    createUrl: (request: Request, response: Response<CreateShortenedUrlResponse | ErrorResponse>) => Promise<Response<ErrorResponse | CreateShortenedUrlResponse, Record<string, any>>>;
